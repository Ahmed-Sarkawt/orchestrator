...
> **Vendored from** [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill) (`skills/taste-skill/SKILL.md`, MIT License).
> **Repo precedence:** for product UI (dashboards, forms, app screens), CLAUDE.md hard rule 7 (shadcn/ui + Lucide base) and rule 4 (cross-browser animations only) take precedence. This skill governs landing pages, portfolios, and marketing surfaces — its own stated scope.
