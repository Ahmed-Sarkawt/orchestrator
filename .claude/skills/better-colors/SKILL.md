...
> **Vendored from** [jakubkrehel/skills](https://github.com/jakubkrehel/skills) (MIT License). In this repo, CLAUDE.md hard rules 4 (cross-browser animations + reduced-motion) and 7 (shadcn/ui + Lucide base) take precedence where they conflict.
